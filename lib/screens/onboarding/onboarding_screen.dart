...
/// Onboarding hérité — 3 écrans maquette Espace Commerçant.
...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
  ...
  static const _pages = [
    _OnboardingData(
      ...
      subtitle: 'Rejoignez des milliers de clients\nau Sénégal',
      icon: Icons.storefront_rounded,
    ),
    _OnboardingData(
      title: 'Suivez vos ventes\nen temps réel',
      subtitle: 'Des statistiques claires pour\nmieux décider',
      icon: Icons.trending_up_rounded,
    ),
    _OnboardingData(
      title: 'Gérez vos commandes\nfacilement',
      subtitle: 'Notifications et assistance\nvia WhatsApp',
